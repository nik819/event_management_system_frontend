      ...
      <div className="mx-10 mt-[65px]">
        <div className="container p-8 mx-auto xl:px-0 flex flex-wrap ">
          <div className="flex items-center w-full lg:w-1/2">
            <div className="max-w-2xl mb-8">
              ...
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                TestDemo is a free landing page &amp; marketing website template
              ...
              <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
                <Link
                  ...
                  target="_blank"
                  rel="noopener"
                  className="px-8 py-4 text-lg font-medium text-center text-white bg-sky-900 rounded-md "
                >
                  Download for Free
                </Link>
                <Link
          ...
          <div className="flex items-center justify-center w-full lg:w-1/2">
            <div className="">
              <img
                className="object-cover h-[617] w-[617]"
                src="./images/hero.png"
        ...
        <div className="container p-8 mx-auto xl:px-0 flex w-full flex-col mt-4 items-center justify-center text-center">
          ...
          <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
            TestDemo is a free landing page &amp; marketing website template for
        ...
        <div className="container p-8 mx-auto xl:px-0 flex flex-wrap mb-20 lg:gap-10 lg:flex-nowrap ">
          <div className="flex items-center justify-center w-full lg:w-1/2 ">
            <div>
              <img
                className="object-cover w-[521] width-[548]"
            ...
            <div>
              <div className="flex flex-col w-full mt-4">
                ...
                <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                  ...
                  feature of your product. It can also contain an img or
          ...
          <div className="flex flex-wrap items-center w-full lg:w-1/2 ">
            <div>
              <div className="flex flex-col w-full mt-4">
                ...
                <p className="max-w-2xl py-4 text-lg leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
                  You can use this same layout with a flip img to highlight your
                  rest of the benefits of your product. It can also contain an
                  img or Illustration as above section along with some bullet
                  points.
                </p>
              </div>
              <div className="w-full mt-5">
                <div className="flex items-start mt-8 space-x-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-500 dark:text-gray-400">
                      TestDemo is designed as a mobile first responsive
                      template.{" "}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start mt-8 space-x-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-gray-500 dark:text-gray-400">
                      TestDemo comes with a zero-config light &amp; dark mode.{" "}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container p-8 mx-auto xl:px-0 ">
          <div className="w-full max-w-4xl mx-auto overflow-hidden lg:mb-20 rounded-2xl ">
            <div className="relative bg-sky-300 cursor-pointer aspect-w-16 aspect-h-9 bg-gradient-to-tr from-purple-400 to-sky-700">
        ...
        <div className="container p-8 mx-auto xl:px-0 ">
          <div className="grid gap-10 lg:grid-cols-2 xl:grid-cols-3">
            <div className="lg:col-span-2 xl:col-auto">
              <div className="flex flex-col justify-between w-full h-full bg-gray-100 px-14 rounded-2xl py-14 dark:bg-slate-800">
          ...
          <div className="w-full max-w-2xl p-2 mx-auto rounded-2xl">
            <div className="mb-5">
              <button
                ...
                id="headlessui-disclosure-button-:R174m:"
                type="button"
                aria-expanded="false"
            ...
            <div className="mb-5">
              <button
                className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                id="headlessui-disclosure-button-:R1b4m:"
                type="button"
                aria-expanded="false"
                data-headlessui-state=""
              >
            ...
            <div className="mb-5">
              <button
                className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                id="headlessui-disclosure-button-:R1f4m:"
                type="button"
                aria-expanded="false"
                data-headlessui-state=""
              >
            ...
            <div className="mb-5">
              <button
                className="flex items-center justify-between w-full px-4 py-4 text-lg text-left  rounded-lg bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-sky-100 focus-visible:ring-opacity-75 dark:bg-slate-800 dark:text-gray-200"
                id="headlessui-disclosure-button-:R1j4m:"
                type="button"
                aria-expanded="false"
                data-headlessui-state=""
              >
        ...
        <div className="container p-8 mx-auto xl:px-0 ">
          <div className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white bg-sky-900 dark:bg-sky-600/10 px-7 py-7 lg:px-12 lg:py-12 lg:flex-nowrap rounded-xl">
            ...
            <div className="flex-shrink-0 w-full text-center lg:w-auto">
              <Link
                ...
                target="_blank"
                rel="noopener"
                className="inline-block py-3 mx-auto text-lg font-medium text-center text-sky-600 bg-white dark:bg-sky-900 dark:text-white rounded-md px-7 lg:px-10 lg:py-5 "
              >
                Download for Free
              </Link>
            </div>
